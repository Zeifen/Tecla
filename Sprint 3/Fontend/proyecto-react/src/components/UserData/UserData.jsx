...
function UserData() {
    ...
    const subirImagen = () =>{
      ...
      if(!imageSelected){
       ...
       formData.append("upload_preset", "hjtlao16");
   
       Axios.post("https://api.cloudinary.com/v1_1/dffk4smr6/image/upload",
       formData
       ).then((response) => {
        ...
        idioma:languages
          ...
          if(data.user.msg = 'Datos Insertados.'){
            setAlert({
              ...
              type: "Success Alert",
              title: "Gracias" ,
              message: "Se completó el registro",
              close:() =>{
                navigate('/posts');
              }
            });
    ...
    <div className="d-flex flex-lg-row flex-column-reverse">
              ...
              <form className="row">
                ...
                <div className="row">
                  <div className="col-md-12 mb-3">
                    ...
                    />
                      <button type="button" id="botonSubirImagen" className="btn botonesTecla mt-3" onClick={subirImagen}>Subir imagen</button>
                  </div>
                </div>
                ...
                <div className="row">
                  ...
                  <div className="col">
                    <label htmlFor="inputState" className="form-label label-Datos">Idioma Natal</label>
                ...
                <div className="row">
                  <div className="col-12 text-center">
                    <button type="button" onClick={datosUsuario} className="btn botonesTecla">Guardar</button>
                  </div>
                </div>
              </form>
            </div>
      ...
      <div className="cardDatos" id="card2">
        <div className="my-auto mx-md-5 px-md-5 right">
          ...
          <h3 className="text-white mt-5">¡Bienvenido a TECLA COMMUNITY!</h3> <small className="text-white">Queremos conocer
            más de ti</small>
            <h3 className="text-white mt-5">Completa tu perfil</h3>
          <div className="row">
