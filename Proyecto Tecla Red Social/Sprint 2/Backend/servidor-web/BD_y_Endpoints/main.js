...
server.listen(process.env.PUERTO, () => {
    console.log('Servidor esta iniciado en el puerto 3000')
});
...
// Otra manera de instanciar el export
/*
const rutaUsuarios = require('./usuariosRed.js');
server.use('/login',rutaUsuarios);
*/
